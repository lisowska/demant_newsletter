...
This document is part of the task deliverables: **feedback you would give in a sparring session** with the Product Owner, Product Designer, or Frontend Developer. It stays close to **what the current app actually does**.
...
**PDF note:** I added a **screenshot mock-up** of how that preview *could* look with icons—only a **design idea for the sparring session**, not something implemented in the app.
